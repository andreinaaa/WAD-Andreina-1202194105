    ...
    <body>
        ...
        <div class="card p-5 m-auto mt-3 mb-3" style="max-width: 700px; margin-top: 100px; margin-bottom: 50px;">
            ...
            <div class="card-body">
                ...
                @foreach($data_vaksin as $y)                     
                    <form action="/vaccines_update" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <input type="hidden" name="id" value="{{ $y->id}}">
                        <h4 style="text-align: center; font-weight: bold;"> Edit Vaccine </h4>
                        <div class="mb-3">
                            <label for="name" class="form-label">Vaccine Name</label>
                            <input type="text" class="form-control" id="name" name="name" value="{{$y->name}}">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" name="image" id="image" value="{{$y->image}}">
                        </div>
                                
                        <input type="submit" name="update" value = "Update" style="width:560px; background-color:#306EFF; height:40px; color: white;">
                    </form>
                @endforeach
                </div>
            </div>
        ...
        <div class="modal fade" id="namamodal" tabindex="-1" aria-labelledby="edit-databuku-modal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <p>Kesan: SUSAHHHH tapi menyenangkan hehehe <br> Pesan: Semangatt teruss bang akbarrr makasih udah ngebimbing aku sama temen-temen 06:) </p>
                    </div>
                </div>
            </div>
        </div>
